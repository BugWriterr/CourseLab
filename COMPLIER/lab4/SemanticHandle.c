...
{ //处理变量列表
    ...
    case EXT_DEC_LIST:
        ...
        if (T->ptr[1])
        {
            T->ptr[1]->offset = T->offset + T->width*T->num;
    ...
    { //处理所以DEC_LIST结点
        ...
        else if (T0->ptr[0]->kind == ASSIGNOP)
        {
            ...
            else
            {
                ...
                opn1.isGlobal=symbolTable.symbols[T0->ptr[0]->ptr[1]->place].level;
